...
class FeedBackBiblioMySqlDAO implements FeedBackBiblioDAO{
    public function insert($feedback) {
        $sql = 'INSERT INTO feedback_biblio (id_biblio, calificacion) '
                . 'VALUES (?, ?)';
    ...
    public function load($id) {
        $sql = 'SELECT * FROM feedback_biblio WHERE NUMERO = ?';
        $sqlQuery = new SqlQuery($sql);
    ...
    public function queryAll() {
        $sql = 'SELECT * FROM feedback_biblio';
        $sqlQuery = new SqlQuery($sql);        
